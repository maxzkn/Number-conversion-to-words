...
function convertNumberToEnglishText(n) {
    ...
    // 100 - 999
    if (len == 3) {
        var x_hundred = ones[parseInt(arr[0])] + ' hundred';
        // 100 - 900
        if (arr[1] == '0' && arr[2] == '0') {
    ...
    // 1000 - 9999
    if (len == 4) {
        var x_thousand = ones[parseInt(arr[0])] + ' thousand';
        var x_hundred = ones[parseInt(arr[1])] + ' hundred';
        // 1000 - 9000
    ...
    // 10000 - 99999
    if (len == 5) {
        var x_thousand = tens[parseInt(arr[0]) - 1] + ' thousand';
        var x_hundred = ones[parseInt(arr[2])] + ' hundred';
        // 10000 - 90000
